...
const Navbar = ({ navigation = [] }) => {
  return (
    <header className="header">
      ...
      <nav className="desktop-nav h-[64px] flex justify-between items-center mx-[24px] md:flex ">
      <div className="flex items-center justify-center">
      <Image src={"/assets/images/ic-logo.svg"} width={50} height={50} alt="Logo" />
      <span className=" text-[32px] font-medium text-gray-900">COLMARAC</span>
      ...
      <nav className="mobile-nav p-2 md:hidden ">
